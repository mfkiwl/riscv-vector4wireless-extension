...
vd[j][i].r = clip_low_SEW(alg_round_shift_right(Tmp.r, mulsft)) //SEW/2=SEW
vd[j][i].i = clip_low_SEW(alg_round_shift_right(Tmp.i, mulsft)) //SEW/2=SEW
...
ACCREG[i].r += Tmp.r
ACCREG[i].i += Tmp.i
vd[0][i].r = clip_low_SEW(alg_round_shift_right(ACCREG[i].r, accsft)) // SEW/2 = ACCREG_LEN
vd[0][i].i = clip_low_SEW(alg_round_shift_right(ACCREG[i].i, accsft)) // SEW/2 = ACCREG_LEN
ACCREG[i] = 0
...
Tmp.r = alg_round_shift_right(Tmp.r, MULSFT[j][i])
ACCREG[i].r += Tmp.r
vd[0][i] = clip_low_SEW(alg_round_shift_right(ACCREG[i].r, accsft)) // SEW = ACCREG_LEN
ACCREG[i].r = 0
...
Tmp.i = alg_round_shift_right(Tmp.i, MULSFT[j][i])
ACCREG[i].i += Tmp.i
vd[0][i] = clip_low_SEW(alg_round_shift_right(ACCREG[i].i, accsft)) // SEW = ACCREG_LEN
ACCREG[i].i = 0
