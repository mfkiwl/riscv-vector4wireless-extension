...
Tmp.i = 0；
For each i in vs2 
Tmp.r += v0.b[i] == 0 ? 0 : vs2[0][i].r
Tmp.i += v0.b[i] == 0 ? 0 : vs2[0][i].i
vd[0][0].r = clip_low_SEW(alg_round_shift_right(Tmp.r, accsft)) // SEW
vd[0][0].i = clip_low_SEW(alg_round_shift_right(Tmp.i, accsft)) // SEW
----
