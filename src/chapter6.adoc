...
ACCREG[i].r += Tmp.r;
ACCREG[i].i += Tmp.i;
vd[0][i].r = clip_low_SEW(alg_round_shift_right(ACCREG[i].r, accsft)) // SEW/2
vd[0][i].i = clip_low_SEW(alg_round_shift_right(ACCREG[i].i, accsft)) // SEW/2
...
Tmp.r = alg_round_shift_right(Tmp.r, MULSFT[j][i]);
ACCREG[i].r += Tmp.r;
vd[0][i] = clip_low_SEW(alg_round_shift_right(ACCREG[i].r, accsft)) // SEW
...
Tmp.i = alg_round_shift_right(Tmp.i, MULSFT[j][i]);
ACCREG[i].i += Tmp.i;
vd[0][i] = clip_low_SEW(alg_round_shift_right(ACCREG[i].i, accsft)) // SEW
