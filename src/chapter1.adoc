...
- min_i: Find the element index in the vector register where the minimum value is located. If there are multiple element equal to minimum value, return the index of the right most one.
- max_i: Find the element index in the vector register where the maximum value is located. If there are multiple element equal to maximum value, return the index of the right most one.
