...
if R_NL_TYPE == 0 ||R_NL_TYPE == 1 || R_NL_TYPE == 2 || R_NL_TYPE == 3 || R_NL_TYPE == 5   % 0：reciprocal; 1: square root; 2: reciprocal of square root; 3: log2; 5: log10;
...
elsif R_NL_TYPE == 6    % sin (x∈Q(32.30))
...
elsif R_NL_TYPE == 7    % cos (x∈Q(32.30))
    msb1 = x & 0x40000000;   % get 31st bit 
    msb2 = x & 0x20000000;   % get 30th bit 
    s    = 1 - 2*xor(msb1, msb2);
    x    = x & 0x1fffffff;   % mod(x,2^29)
