...
#endif
#ifdef GENERATOR_FILE
extern int riscv_xc_subext;
#else
  int x_riscv_xc_subext;
#define riscv_xc_subext global_options.x_riscv_xc_subext
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_zvw_subext;
#else
  int x_riscv_zvw_subext;
#define riscv_zvw_subext global_options.x_riscv_zvw_subext
#endif
#ifdef GENERATOR_FILE
...
#define MASK_LONG_DOUBLE_128 (1U << 4)
#define MASK_OMIT_LEAF_FRAME_POINTER (1U << 5)
#define MASK_WING_OPT_CONSTANT (1U << 6)
#define MASK_SAVE_RESTORE (1U << 7)
#define MASK_STRICT_ALIGN (1U << 8)
#define MASK_WING_REDUCE_REGS (1U << 9)
#define MASK_64BIT (1U << 10)
#define MASK_ATOMIC (1U << 11)
#define MASK_DOUBLE_FLOAT (1U << 12)
#define MASK_FULL_V (1U << 13)
#define MASK_HARD_FLOAT (1U << 14)
#define MASK_MUL (1U << 15)
#define MASK_RVC (1U << 16)
#define MASK_RVE (1U << 17)
#define MASK_VECTOR (1U << 18)
...
#define MASK_XBERV (1U << 0)
#define MASK_XC (1U << 1)
#define MASK_XCCI (1U << 2)
#define MASK_XCLS (1U << 3)
#define MASK_XCPA (1U << 4)
...
#define TARGET_XBERV ((riscv_xc_subext & MASK_XBERV) != 0)
#define TARGET_XBERV_P(riscv_xc_subext) (((riscv_xc_subext) & MASK_XBERV) != 0)
#define TARGET_XBERV_OPTS_P(opts) (((opts->x_riscv_xc_subext) & MASK_XBERV) != 0)
#define TARGET_XC ((riscv_xc_subext & MASK_XC) != 0)
#define TARGET_XC_P(riscv_xc_subext) (((riscv_xc_subext) & MASK_XC) != 0)
#define TARGET_XC_OPTS_P(opts) (((opts->x_riscv_xc_subext) & MASK_XC) != 0)
#define TARGET_XCCI ((riscv_xc_subext & MASK_XCCI) != 0)
#define TARGET_XCCI_P(riscv_xc_subext) (((riscv_xc_subext) & MASK_XCCI) != 0)
#define TARGET_XCCI_OPTS_P(opts) (((opts->x_riscv_xc_subext) & MASK_XCCI) != 0)
#define TARGET_XCLS ((riscv_xc_subext & MASK_XCLS) != 0)
#define TARGET_XCLS_P(riscv_xc_subext) (((riscv_xc_subext) & MASK_XCLS) != 0)
#define TARGET_XCLS_OPTS_P(opts) (((opts->x_riscv_xc_subext) & MASK_XCLS) != 0)
#define TARGET_XCPA ((riscv_xc_subext & MASK_XCPA) != 0)
#define TARGET_XCPA_P(riscv_xc_subext) (((riscv_xc_subext) & MASK_XCPA) != 0)
#define TARGET_XCPA_OPTS_P(opts) (((opts->x_riscv_xc_subext) & MASK_XCPA) != 0)
...
#define TARGET_ZVW ((riscv_zvw_subext & MASK_ZVW) != 0)
#define TARGET_ZVW_P(riscv_zvw_subext) (((riscv_zvw_subext) & MASK_ZVW) != 0)
#define TARGET_ZVW_OPTS_P(opts) (((opts->x_riscv_zvw_subext) & MASK_ZVW) != 0)
...
/* WING_OPT_CONSTANT mask */
#define TARGET_WING_OPT_CONSTANT ((target_flags & MASK_WING_OPT_CONSTANT) != 0)
#define TARGET_WING_OPT_CONSTANT_P(target_flags) (((target_flags) & MASK_WING_OPT_CONSTANT) != 0)
#define TARGET_WING_OPT_CONSTANT_OPTS_P(opts) (((opts->x_target_flags) & MASK_WING_OPT_CONSTANT) != 0)
#define TARGET_EXPLICIT_WING_OPT_CONSTANT_P(opts) ((opts->x_target_flags_explicit & MASK_WING_OPT_CONSTANT) != 0)
#define SET_TARGET_WING_OPT_CONSTANT(opts) opts->x_target_flags |= MASK_WING_OPT_CONSTANT
/* SAVE_RESTORE mask */
...
/* WING_REDUCE_REGS mask */
#define TARGET_WING_REDUCE_REGS ((target_flags & MASK_WING_REDUCE_REGS) != 0)
#define TARGET_WING_REDUCE_REGS_P(target_flags) (((target_flags) & MASK_WING_REDUCE_REGS) != 0)
#define TARGET_WING_REDUCE_REGS_OPTS_P(opts) (((opts->x_target_flags) & MASK_WING_REDUCE_REGS) != 0)
#define TARGET_EXPLICIT_WING_REDUCE_REGS_P(opts) ((opts->x_target_flags_explicit & MASK_WING_REDUCE_REGS) != 0)
#define SET_TARGET_WING_REDUCE_REGS(opts) opts->x_target_flags |= MASK_WING_REDUCE_REGS
...
enum opt_code
{
  ...
  OPT__wing_version = 397,                   /* --wing-version */
  ...
  OPT_Wall = 459,                            /* -Wall */
  OPT_Walloc_size = 460,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 461,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 462,                     /* -Walloc-zero */
  OPT_Walloca = 463,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 464,            /* -Walloca-larger-than= */
  OPT_Wampersand = 465,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 466,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 467,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 468,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 469,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 470,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 471,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 472,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 473,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 474,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 475,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 476,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 477,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 478,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 479,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 480,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 481,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_loop = 482,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 483,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 484,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 485,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 486,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 487,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 488,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 489,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 490,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 491,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 492,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 493,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 494,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 495,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 496,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 497,    /* -Wanalyzer-symbol-too-complex */
  OPT_Wanalyzer_tainted_allocation_size = 498,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 499,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 500,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 501,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 502,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 503,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 504,           /* -Wanalyzer-too-complex */
  ...
  /* OPT_fwing_version = 1889, */            /* -fwing-version */
  ...
  OPT_malign_data_ = 1962,                   /* -malign-data= */
  OPT_march_ = 1963,                         /* -march= */
  OPT_march_help = 1964,                     /* -march=help */
  OPT_mbig_endian = 1965,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1966,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1967,                       /* -mcmodel= */
  OPT_mcpu_ = 1968,                          /* -mcpu= */
  OPT_mcsr_check = 1969,                     /* -mcsr-check */
  OPT_mdiv = 1970,                           /* -mdiv */
  OPT_mexplicit_relocs = 1971,               /* -mexplicit-relocs */
  OPT_mfdiv = 1972,                          /* -mfdiv */
  OPT_minline_atomics = 1973,                /* -minline-atomics */
  OPT_minline_strcmp = 1974,                 /* -minline-strcmp */
  OPT_minline_strlen = 1975,                 /* -minline-strlen */
  OPT_minline_strncmp = 1976,                /* -minline-strncmp */
  OPT_misa_spec_ = 1977,                     /* -misa-spec= */
  OPT_mlittle_endian = 1978,                 /* -mlittle-endian */
  OPT_mlong_double_128 = 1979,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1980,                /* -mlong-double-64 */
  OPT_mmovcc = 1981,                         /* -mmovcc */
  OPT_momit_leaf_frame_pointer = 1982,       /* -momit-leaf-frame-pointer */
  OPT_mopt_constant = 1983,                  /* -mopt-constant */
  OPT_mplt = 1984,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1985,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1986,                         /* -mrelax */
  OPT_mriscv_attribute = 1987,               /* -mriscv-attribute */
  OPT_mrvv_max_lmul_ = 1988,                 /* -mrvv-max-lmul= */
  OPT_mrvv_vector_bits_ = 1989,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 1990,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1991,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1992,             /* -msmall-data-limit= */
  OPT_mstack_protector_guard_offset_ = 1993, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1994,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1995,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1996,                  /* -mstrict-align */
  OPT_mstringop_strategy_ = 1997,            /* -mstringop-strategy= */
  OPT_mtls_dialect_ = 1998,                  /* -mtls-dialect= */
  OPT_mtune_ = 1999,                         /* -mtune= */
  OPT_mwing_reduce_regs = 2000,              /* -mwing-reduce-regs */
  OPT_n = 2001,                              /* -n */
  OPT_name_sort = 2002,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2003,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2004,              /* -no-integrated-cpp */
  OPT_no_pie = 2005,                         /* -no-pie */
  OPT_nocpp = 2006,                          /* -nocpp */
  OPT_nodefaultlibs = 2007,                  /* -nodefaultlibs */
  OPT_nolibc = 2008,                         /* -nolibc */
  OPT_nophoboslib = 2009,                    /* -nophoboslib */
  OPT_nostartfiles = 2010,                   /* -nostartfiles */
  OPT_nostdinc = 2011,                       /* -nostdinc */
  OPT_nostdinc__ = 2012,                     /* -nostdinc++ */
  OPT_nostdlib = 2013,                       /* -nostdlib */
  OPT_nostdlib__ = 2014,                     /* -nostdlib++ */
  OPT_o = 2015,                              /* -o */
  OPT_objects = 2016,                        /* -objects */
  OPT_p = 2017,                              /* -p */
  OPT_pass_exit_codes = 2018,                /* -pass-exit-codes */
  /* OPT_pedantic = 2019, */                 /* -pedantic */
  OPT_pedantic_errors = 2020,                /* -pedantic-errors */
  OPT_pg = 2021,                             /* -pg */
  OPT_pie = 2022,                            /* -pie */
  OPT_pipe = 2023,                           /* -pipe */
  OPT_print_file_name_ = 2024,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2025,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2026,          /* -print-multi-directory */
  OPT_print_multi_lib = 2027,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2028,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2029,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2030,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2031,               /* -print-prog-name= */
  OPT_print_search_dirs = 2032,              /* -print-search-dirs */
  /* OPT_print_supported_extensions = 2033, *//* -print-supported-extensions */
  OPT_print_sysroot = 2034,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2035,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2036,                    /* -print-value */
  OPT_quiet = 2037,                          /* -quiet */
  OPT_r = 2038,                              /* -r */
  OPT_remap = 2039,                          /* -remap */
  OPT_reverse_sort = 2040,                   /* -reverse-sort */
  OPT_s = 2041,                              /* -s */
  OPT_save_temps = 2042,                     /* -save-temps */
  OPT_save_temps_ = 2043,                    /* -save-temps= */
  OPT_shared = 2044,                         /* -shared */
  OPT_shared_libgcc = 2045,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2046,               /* -shared-libphobos */
  OPT_size_sort = 2047,                      /* -size-sort */
  /* OPT_specs = 2048, */                    /* -specs */
  OPT_specs_ = 2049,                         /* -specs= */
  OPT_static = 2050,                         /* -static */
  OPT_static_libasan = 2051,                 /* -static-libasan */
  OPT_static_libgcc = 2052,                  /* -static-libgcc */
  OPT_static_libgfortran = 2053,             /* -static-libgfortran */
  OPT_static_libgm2 = 2054,                  /* -static-libgm2 */
  OPT_static_libgo = 2055,                   /* -static-libgo */
  OPT_static_libhwasan = 2056,               /* -static-libhwasan */
  OPT_static_liblsan = 2057,                 /* -static-liblsan */
  OPT_static_libmpx = 2058,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2059,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2060,               /* -static-libphobos */
  OPT_static_libquadmath = 2061,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2062,               /* -static-libstdc++ */
  OPT_static_libtsan = 2063,                 /* -static-libtsan */
  OPT_static_libubsan = 2064,                /* -static-libubsan */
  OPT_static_pie = 2065,                     /* -static-pie */
  /* OPT_std_c__03 = 2066, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2067, */                /* -std=c++0x */
  OPT_std_c__11 = 2068,                      /* -std=c++11 */
  OPT_std_c__14 = 2069,                      /* -std=c++14 */
  OPT_std_c__17 = 2070,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2071, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2072, */                /* -std=c++1z */
  OPT_std_c__20 = 2073,                      /* -std=c++20 */
  OPT_std_c__23 = 2074,                      /* -std=c++23 */
  OPT_std_c__26 = 2075,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2076, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2077, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2078, */                /* -std=c++2c */
  OPT_std_c__98 = 2079,                      /* -std=c++98 */
  OPT_std_c11 = 2080,                        /* -std=c11 */
  OPT_std_c17 = 2081,                        /* -std=c17 */
  /* OPT_std_c18 = 2082, */                  /* -std=c18 */
  /* OPT_std_c1x = 2083, */                  /* -std=c1x */
  OPT_std_c23 = 2084,                        /* -std=c23 */
  /* OPT_std_c2x = 2085, */                  /* -std=c2x */
  /* OPT_std_c89 = 2086, */                  /* -std=c89 */
  OPT_std_c90 = 2087,                        /* -std=c90 */
  OPT_std_c99 = 2088,                        /* -std=c99 */
  /* OPT_std_c9x = 2089, */                  /* -std=c9x */
  OPT_std_f2003 = 2090,                      /* -std=f2003 */
  OPT_std_f2008 = 2091,                      /* -std=f2008 */
  OPT_std_f2008ts = 2092,                    /* -std=f2008ts */
  OPT_std_f2018 = 2093,                      /* -std=f2018 */
  OPT_std_f2023 = 2094,                      /* -std=f2023 */
  OPT_std_f95 = 2095,                        /* -std=f95 */
  OPT_std_gnu = 2096,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2097, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2098, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2099,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2100,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2101,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2102, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2103, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2104,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2105,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2106,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2107, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2108, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2109, */              /* -std=gnu++2c */
  ...
  OPT_std_gnu23 = 2115,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2116, */                /* -std=gnu2x */
  /* OPT_std_gnu89 = 2117, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2118,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2119,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2120, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2121, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2122,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2123, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2124, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2125, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2126, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2127, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2128, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2129,                     /* -std=legacy */
  OPT_stdlib_ = 2130,                        /* -stdlib= */
  ...
  OPT_type_stats = 2140,                     /* -type-stats */
  OPT_u = 2141,                              /* -u */
  OPT_undef = 2142,                          /* -undef */
  OPT_v = 2143,                              /* -v */
  OPT_version = 2144,                        /* -version */
  OPT_w = 2145,                              /* -w */
  OPT_wrapper = 2146,                        /* -wrapper */
  OPT_x = 2147,                              /* -x */
  OPT_z = 2148,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
