...
enum riscv_address_type {
  ...
  ADDRESS_CONST_INT,
  ADDRESS_SYMBOLIC,
  ADDRESS_REG_INC_POST,  /* wingsemi specific - insn sched - 202405. */
  ADDRESS_REG_INC_PRE    /* wingsemi specific - insn sched - 202405. */
};
...
bool riscv_legitimate_xcls_address_p (machine_mode, rtx, bool);  /* wingsemi specific - insn sched - 202405. */
bool riscv_legitimate_xcls_addr_inc_imm_p (rtx x);               /* wingsemi specific - insn sched - 202405. */
bool riscv_legitimate_xcls_addr_inc_reg_p (machine_mode mode, rtx x, bool strict_p);  /* wingsemi specific - insn sched - 202405. */
